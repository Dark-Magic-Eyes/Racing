...
gdjs.PlayingCode.mapOfGDgdjs_9546PlayingCode_9546GDGreyCarObjects2Objects = Hashtable.newFrom({"GreyCar": gdjs.PlayingCode.GDGreyCarObjects2});
gdjs.PlayingCode.asyncCallback15055428 = function (runtimeScene, asyncObjectsList) {
}
...
};gdjs.PlayingCode.asyncCallback15055804 = function (runtimeScene, asyncObjectsList) {
...
{
const asyncObjectsList = new gdjs.LongLivedObjectsList();
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(2), (runtimeScene) => (gdjs.PlayingCode.asyncCallback15055804(runtimeScene, asyncObjectsList)));
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(15054876);
}
}
}
if (isConditionTrue_0) {
